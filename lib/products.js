...
// Initialize normalized synonym groups for performance
function initializeNormalizedSynonymGroups() {
...
function getSynonyms(token = '') {
    // Lazy initialization of normalized synonym groups
...
function getProductTokens(product = {}) {
    ...
    // Synonym matching will be done during the search comparison
...
export function findMatchingProducts(query = '', products = [], limit = null) {
    ...
    const scored = products
        .map((product) => {
            ...
            // Check for exact, synonym, and fuzzy matches
            ...
            return { product, score, exactMatches, synonymMatches, fuzzyMatches };
        })
        ...
        .sort((a, b) => {
            ...
            return b.synonymMatches - a.synonymMatches;
        });
