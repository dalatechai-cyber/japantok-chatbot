 ...
 */
function extractCleanDisplayName(title = '', tokCode = '', maxLength = 100) {
...
function normalizeProduct(row = {}) {
    ...
    return {
        ...
        name: title,
        title: title, // Keep title field for compatibility search
        tokCode,
        ...
        priceWithoutVat: '', // Empty - not used anymore
        rawPriceWithVat: priceWholesaleWithVat,
        rawPriceWithoutVat: '', // Empty - not used anymore
        stock,
        raw: cleaned
    };
}
