...
function buildSystemInstruction(contextText, matchCount, userMessage = '') {
    return `Та бол "Japan Tok Mongolia" компанийн албан ёсны хиймэл оюун ухаант туслах.\n\n` +
        ...
        `7. Хариултын төгсгөлд холбоо барих мэдээлэл БҮТЭЭЛ БИТГИЙ нэмээрэй. Зөвхөн хэрэглэгч холбоо барих утас, дугаар, захиалах эсвэл хаяг асуусан тохиолдолд л "${CONTACT_LINE} ${CONTACT_FULL_TEXT} ${CONTACT_NUMBERS}" мэдээллийг өг.\n` +
...
function isAskingForContact(message = '') {
    ...
    const contactKeywords = [
        ...
        'хэдэн',          // what (in context of asking for number)
        'contact',
        'phone',
        'number',
        'call',
